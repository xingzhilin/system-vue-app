<template>
	<div class="goods_wrap">
		...
		<el-table :data="tableData" border size="small">
		    ...
		    <el-table-column align="center" prop="assaysCostType" label="云供应商点价价格（元/吨）"></el-table-column>
		    <el-table-column align="center" prop="assaysCostTypeCode" label="云采购商点价价格（元/吨）"></el-table-column>
		    <el-table-column align="center" prop="assaysCostTypeCode" label="点价差值（元/吨）"></el-table-column>
		    <el-table-column align="center" prop="createDate" label="更新时间"></el-table-column>
		    <el-table-column align="center" prop="createDate" label="操作人"></el-table-column>
		    <el-table-column align="center" label="状态">
		    	<template slot-scope="props">
		    		<span v-if="props.row.status == 1">xianshi</span>  
       				<span v-else>不xianshi</span>
			    </template>
		    </el-table-column>
		</el-table>
	...
	export default {
		...
		methods: {
			...
			handleCheck(index, row){
				console.log(row);
		        this.$router.push({name: 'releaseInquiryViewLink', params: {id: row.id}});
			},
			handleEdit(index, row) {
		        console.log(index, row);
		        this.$router.push({name: 'releaseInquiryUpdateLink'});
		    },
