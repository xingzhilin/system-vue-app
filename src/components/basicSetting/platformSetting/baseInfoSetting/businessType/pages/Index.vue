<template>
	<div class="backstage">
		...
		<el-form-item label="业务类型：" >
		    <el-input v-model="formInline.bizType" placeholder="" size="small"></el-input>
		  </el-form-item>
		  <el-form-item>
		...
		<el-container>
      <router-link :to="{path:'/platform/baseInfo/businessType/Add'}" >
		...
		<el-table :data="tableData" border size="small">
		  <el-table-column prop="" label="操作" width="180" align="center">		    	
		    <template slot-scope="scope">
					<router-link :to="{path:'/platform/baseInfo/businessType/See',query:{id:scope.row.id}}">
		    		<el-button type="primary" size="mini">查看</el-button>
					</router-link>  
					<router-link :to="{path:'/platform/baseInfo/businessType/Deal'}">	
		    		<el-button size="mini">处理</el-button>
					</router-link> 	
			  </template>
		  </el-table-column>
		  <el-table-column align="center" prop="bizType" label="业务类型"></el-table-column>
		  <el-table-column align="center" prop="masterBizCode" label="业务类型code"></el-table-column>
			<el-table-column align="center" prop="acroCode" label="缩写码"></el-table-column>
		  <el-table-column align="center" prop="masterBizName" label="所属业务种类"></el-table-column>
