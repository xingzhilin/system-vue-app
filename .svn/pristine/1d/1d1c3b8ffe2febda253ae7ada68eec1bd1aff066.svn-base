	...
	<div class="backstage">
		...
		<el-form :inline="true" :model="form" ref="form" class="demo-form-inline">
		  <el-form-item label="船务费用名称" prop="userName">
		    <el-input v-model="form.userName" placeholder="船务费用名称" size="small"></el-input>
		  </el-form-item>	
		...
		<el-table :data="tableData" border size="small">
		    <el-table-column label="操作" width="180" align="center">		    	
		    	<template slot-scope="scope">
		    		<router-link :to="{name:'shippingCostViewLink', query:{expenseId: scope.row.expenseId}}">
		    			<el-button type="primary" size="mini">查看</el-button>
		    		</router-link>
		    		<router-link :to="{name:'shippingCostUpdateLink', query:{expenseId: scope.row.expenseId}}">
		    			<el-button size="mini">处理</el-button>
		    		</router-link>		
			      </template>
		    </el-table-column>
		    <el-table-column align="center" prop="expenseName" label="船务费用类型"></el-table-column>
		    <el-table-column align="center" prop="expenseId" label="船务费用类型code"></el-table-column>
