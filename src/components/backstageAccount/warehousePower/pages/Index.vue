		...
		<el-table :data="tableData" border size="small" v-loading="isLoading">
		    <el-table-column prop="" label="操作" width="260" align="center">		    	
		    	<template slot-scope="scope">
		    		<router-link :to="{name: 'warehousePowerViewLink', query: {whCode:scope.row.whCode}}">
		    			<el-button type="primary" size="mini">查看</el-button>
		    		</router-link>
		    		<router-link :to="{name: 'warehousePowerUpdateLink', query: {whCode:scope.row.whCode}}">
		    			<el-button size="mini">处理</el-button>
		    		</router-link>
			      </template>
		    </el-table-column>
		    <el-table-column align="center" prop="whName" label="交割库名称"></el-table-column>
		    <el-table-column align="center" prop="status" label="交割库状态"></el-table-column>
		</el-table>
	...
	export default {
		...
		methods: {
		    ...
		    initList(toPage, pageSize){
				...
				this.$axios.post('http://192.168.11.98:9001/admin/warehouses', this.sParams , {
