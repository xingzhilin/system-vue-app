<template>
	<div class="backstage">
		...
		<el-form-item label="检验标准：" >
		    <el-input v-model="formInline.testStandard" placeholder="" size="small"></el-input>
		</el-form-item>
		...
		<el-table :data="tableData" border size="small">
		  <el-table-column prop="" label="操作" width="180" align="center">		    	
		    <template slot-scope="scope">
					...
					<router-link :to="{path:'/platform/baseInfo/delivery/deal'}">	
		    		<el-button size="mini">处理</el-button>
					</router-link> 	
			  </template>
		  </el-table-column>
		  <el-table-column align="center" prop="testStandard" label="检验标准"></el-table-column>
		  <el-table-column align="center" prop="testStandardCode" label="检验标准code"></el-table-column>
