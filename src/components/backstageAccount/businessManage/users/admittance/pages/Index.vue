	...
	<div class="account">
		...
		<el-form :inline="true" :model="formInline" ref="formInline" class="demo-form-inline">
		  <el-form-item label="企业名称：" prop="userName">
		    <el-input v-model="formInline.userName" placeholder="企业名称" size="small"></el-input>
		  </el-form-item>
		  <el-form-item label="企业编码：" prop="trueUserName">
		    <el-input v-model="formInline.trueUserName" placeholder="企业编码" size="small"></el-input>
		  </el-form-item>		  
		  <el-form-item label="公司状态：" prop="userStatus">
		  ...
		  <el-form-item label="准入协议号：" prop="departName">
		    <el-input v-model="formInline.departName" placeholder="准入协议号" size="small"></el-input>
		  </el-form-item>
		  <el-form-item label="准入时间：" prop="departName">
		    <el-col :span="11">
		      <el-date-picker type="datetime" v-model="formInline.userStatus" placeholder="选择日期" style="width: 100%;" size="small"></el-date-picker>
		    </el-col>
		  ...
		  <el-form-item label="供货准入状态：" prop="userStatus">
		    <el-select v-model="formInline.userStatus" placeholder="请选择" size="small">  
		      <el-option label="请选择" value=""></el-option>
		      <el-option label="启用" value="1"></el-option>
		      <el-option label="停用" value="0"></el-option>
