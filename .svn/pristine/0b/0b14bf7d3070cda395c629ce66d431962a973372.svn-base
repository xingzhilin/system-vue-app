    ...
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>煤炭商城商品发布</el-breadcrumb-item>
            ...
            <el-container>
	        	<router-link :to="{path:'/goods/cloudPurchase/add'}" >
            ...
            <el-table :data="tableData" border>
                <el-table-column prop="" label="操作" width="150">                
                    <template slot-scope="scope">
                        <router-link :to="{path:'/goods/cloudPurchase/see',query:{offerNo:scope.row.offerNo}}">
                            <el-button type="primary" size="mini">查看</el-button>
                        </router-link>  
                        <router-link :to="{path:'/goods/cloudPurchase/editor',query:{offerNo:scope.row.offerNo}}">
                            <el-button size="mini">处理</el-button>
                        </router-link>  
                     </template>
                </el-table-column>
                <el-table-column prop="whName" label="交割库"></el-table-column>
                <el-table-column prop="salesTotal" label="销售总量"></el-table-column>
                <el-table-column prop="inventory" label="报盘库存"></el-table-column>
                <el-table-column prop="offerStartDate" label="销售开始时间"></el-table-column>
                <el-table-column prop="offerEndDate" label="销售结束时间"></el-table-column>
                <el-table-column prop="statusDesc" label="报盘状态"></el-table-column>
                <el-table-column prop="publishTime" label="报盘发布时间"></el-table-column>
