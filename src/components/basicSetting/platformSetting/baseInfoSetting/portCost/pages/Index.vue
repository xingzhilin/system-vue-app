<template>
	<div class="backstage">
		...
		<el-table :data="tableData" border size="small">
		    ...
		    <el-table-column align="center" prop="portCostType" label="港口费用类型"></el-table-column>
		    <el-table-column align="center" prop="portCostTypeCode" label="港口费用类型code"></el-table-column>
