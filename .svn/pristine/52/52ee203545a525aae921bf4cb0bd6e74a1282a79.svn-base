<template>
	<div>
        <!-- <el-col :lg="{span:18,offset:3}" :xs="{span:22,offset:1}" :md="{span:20,offset:2}" :sm="{span:22,offset:1}"> -->
            ...
            <el-form-item label="品牌logo：" class="mg0"  prop="brandLogos" :inline-message="true">    <div class="uploadBox">
                  <el-upload
            ...
            <el-form-item label="品牌图片：" class="mg0"  prop="brandImgs" :inline-message="true">    <div class="uploadBox">
                  <el-upload
                    action="http://219.149.226.180:7884/landflow/common/uploadFile.do"
                    list-type="picture-card"
