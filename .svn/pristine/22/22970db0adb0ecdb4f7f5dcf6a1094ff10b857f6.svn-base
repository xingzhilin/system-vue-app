		  ...
		  <el-breadcrumb-item>平台基础设置</el-breadcrumb-item>
			...
			<el-form :inline="true" :model="formInline">
			  <el-form-item label="品类名称：">
			    <el-input v-model="formInline.catName" size="small"></el-input>
			  </el-form-item>
			...
			<el-container>
	        	<router-link :to="{path:'/platform/coalType/categoryValue/editor'}" >
	        		<el-button type="danger" size="small">添加品类参数</el-button> 
	        	</router-link> 
	        </el-container>
			<el-table :data="tableData" border>
			    <el-table-column prop="" label="操作" width="150">		    	
			    	<template slot-scope="scope">
			    		<router-link :to="{path:'/platform/coalType/categoryValue/see',query:{catCode:scope.row.catCode}}">
			    			<el-button type="primary" size="mini">查看</el-button>
			    		</router-link>	
			    		<router-link :to="{path:'/platform/coalType/categoryValue/editor',query:{catCode:scope.row.catCode}}">
			    			<el-button size="mini">处理</el-button>
			    		</router-link>	
				     </template>
			    </el-table-column>
			    <el-table-column prop="catName" label="品类"></el-table-column>
