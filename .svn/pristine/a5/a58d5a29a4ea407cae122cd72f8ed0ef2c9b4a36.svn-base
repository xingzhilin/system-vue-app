<template>
	<div class="order_wrap">
		<el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>化验管理</el-breadcrumb-item>
          <el-breadcrumb-item>化验录入</el-breadcrumb-item>
		</el-breadcrumb>
		<el-form :inline="true" :model="formInline" ref="formInline" class="demo-form-inline">
		  ...
		  <el-form-item label="品种：" prop="userName">
		    <el-input v-model="formInline.userName" placeholder="交割库" size="small"></el-input>
		  </el-form-item>
		  ...
		  <el-col :span="24">
		  	<div class="grid-content bg-purple-dark" v-for="item in tableData">
		  		<div class="table_header">
		  			<el-col :span="4">
			  			<span>定价</span>
			  			<router-link :to="{name: 'testsInputAddLink', query: {orderNo: item.orderNo, tranterType: item.tranterType}}">
